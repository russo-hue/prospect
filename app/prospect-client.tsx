  ...
  return <>
    ...
    <main id="conteudo">
      <section className="hero" id="inicio"><div className="glow g1"/><div className="glow g2"/>
        <div className="shell hero-grid">
          ...
          <div className="product-stage">
            <div className="window"><div className="window-bar"><i/><i/><i/><span>prospect-pf.svssolucoes.com.br</span></div><Image unoptimized src={`${BASE_PATH}/images/dashboard-main.png`} alt="Painel real do Prospect PF com indicadores e anúncios de veículos" width={1544} height={867} priority /></div>
      ...
      <section className="section command"><div className="shell"><div className="section-title"><div><div className="kicker">Visão do painel</div><h2>Um centro de comando para sua <span>captação</span></h2></div><p>Centralize as oportunidades e saiba exatamente quais anúncios precisam de atenção.</p></div>
        <div className="dashboard-showcase"><div className="window large"><div className="window-bar"><i/><i/><i/><span>Painel Prospect PF</span></div><Image unoptimized src={`${BASE_PATH}/images/dashboard-listings.png`} alt="Lista de oportunidades e filtros no painel do Prospect PF" width={837} height={814}/></div>
